...
- 인용 tweet은 `QUOTE` 배지와 `ORIGINAL TWEET · 인용 원문` 카드/구분선으로 명확히 구별해서 표시합니다.
...
`dist/x-thread-clean-capture-firefox-v1.0.7.zip` 파일은 `manifest.json`이 archive root에 오도록 만든 Firefox WebExtension ZIP입니다.
